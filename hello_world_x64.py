...
CODE = (
    ...
    "   mov cx, 0x6c6c                  ;"
    "   push rcx                        ;"
    "   mov   rcx, 0x642e323372657375   ;" # user32.dll = 'lld.23resu'.encode("utf-8").hex()
    "   push   rcx                      ;"
    "   mov   rcx, rsp                  ;"
    "   sub   rsp, 0x20                 ;"
    ...
    "   mov r10d, 0xBC4DA2A8            ;" # MesssageBoxA ror13 hash
    "   call r15                        ;" # Call find_function
    "   mov [rbp+0x18], rax             ;" # Store MessageBoxA address

    "call_messageboxa:                   "
    "   xor rcx, rcx                    ;" # set hWnd
    "   xor r9, r9                      ;" # set uType
    "   xor rdx, rdx                    ;"
    "   mov edx, 0x21646c72             ;"
    "   push rdx                        ;"
    "   mov rdx, 0x6f57206f6c6c6548     ;" # "Hello World!"[::-1].encode('utf-8').hex()
    "   push rdx                        ;"
